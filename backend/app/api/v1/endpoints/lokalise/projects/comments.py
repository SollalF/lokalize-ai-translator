...
router = APIRouter(tags=["lokalise-comments"])


@router.get("/comments", response_model=ProjectCommentsResponse)
...
@router.get(
    "/keys/{key_id}/comments/{comment_id}",
...
async def get_comment(
    ...
    Mirrors Lokalise API endpoint:
    GET https://api.lokalise.com/api2/projects/{project_id}/keys/{key_id}/comments/{comment_id}
